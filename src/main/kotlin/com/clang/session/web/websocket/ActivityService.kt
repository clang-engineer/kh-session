package com.clang.session.web.websocket

import com.clang.session.config.WebsocketConfiguration.Companion.IP_ADDRESS
import com.clang.session.web.websocket.dto.ActivityDTO
